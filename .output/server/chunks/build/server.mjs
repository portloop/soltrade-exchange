...
const _routes = [
  {
    ...
    component: () => import('./connectButton-CEqYWpzM.mjs').then(m => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import('./index-DnF5YYDB.mjs').then(m => m.default || m)
  },
  {
    name: "onramp",
    path: "/onramp",
  ...
  },
  {
    ...
    component: () => import('./trade-Dcqqhmkd.mjs').then(m => m.default || m)
  }
];
...
function scrollAnimation_Kp9Tv285Zn() {
}
...
const solana_eKejMqthzR = defineNuxtPlugin((nuxtApp) => {
