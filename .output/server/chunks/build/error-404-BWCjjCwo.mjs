...
import { u as useHead } from './index-rp5EgFvO.mjs';
  ...
  return defineComponent({
    ...
    setup(props, { slots }) {
      ...
      return () => {
        ...
        const href = typeof to.value === "object" ? (_b = (_a = router.resolve(to.value)) == null ? void 0 : _a.href) != null ? _b : null : to.value && !props.external && !isAbsoluteUrl.value ? resolveTrailingSlashBehavior(joinURL(config.app.baseURL, to.value), router.resolve) : to.value || null;
...
//# sourceMappingURL=error-404-BWCjjCwo.mjs.map
